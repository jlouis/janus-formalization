...
Leroy et al\fixme{Citation}. The work is taken from the
...
on algebra\fixme{Cite}. First, we have
\begin{defn}
...
integers, and we only used Presburger arithmetic\fixme{Citation} we
